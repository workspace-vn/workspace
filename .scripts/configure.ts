...
if (!env.IS_DOCKER) {
	...
	export const environment: Environment = 
	{
		...
		COMPANY_GITHUB_LINK: 'https://github.com/workspace-vn',
		COMPANY_GITLAB_LINK: 'https://gitlab.com/workspace-vn',
		COMPANY_FACEBOOK_LINK: 'https://www.facebook.com/gauzyplatform',
		COMPANY_TWITTER_LINK: 'https://twitter.com/gauzyplatform',
		COMPANY_LINKEDIN_LINK: 'https://www.linkedin.com/company/workspace-vn.',
