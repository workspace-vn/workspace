...
[![Gitpod Ready-to-Code](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/workspace-vn/workspace)

## 💡 What's New

We released [Ever Gauzy Teams](https://github.com/workspace-vn/workspace-teams) platform for Work & Project Management.  
Please check <https://github.com/workspace-vn/workspace-teams> and make it ⭐ on GitHub!  
...
Read more [about Gauzy](https://github.com/workspace-vn/workspace/wiki/About-Gauzy) and [how to use it](https://github.com/workspace-vn/workspace/wiki/How-to-use-Gauzy) at your company, on-demand business, freelance business, agency, studio or in-house teams.
...
- [Platform Releases](https://github.com/workspace-vn/workspace/releases)
- [Server Releases](https://github.com/workspace-vn/workspace-server/releases)
- [Desktop App Releases](https://github.com/workspace-vn/workspace-desktop/releases)
- [Desktop Timer App Releases](https://github.com/workspace-vn/workspace-desktop-timer/releases)
...
- You can read more information about our Desktop Apps in the [Desktop Apps Wiki Page](https://github.com/workspace-vn/workspace/wiki/Gauzy-Desktop-Apps) and about our Server in the [Server Wiki Page](https://github.com/workspace-vn/workspace/wiki/Gauzy-Server).
...
Please refer to our official [Platform Documentation](https://docs.gauzy.co) and to our [Wiki](https://github.com/workspace-vn/workspace/wiki) (WIP).
...
- Adjust settings in the [`.env.local`](https://github.com/workspace-vn/workspace/blob/develop/.env.local) which used in local runs.
- Alternatively, you can copy [`.env.sample`](https://github.com/workspace-vn/workspace/blob/develop/.env.sample) to `.env` and change default settings there, e.g. database type, name, user, password, etc.
...
- See [Setup Gauzy for Client Server](https://github.com/workspace-vn/workspace/wiki/Setup-Gauzy-for-Client-Server) for more information about production setup on your servers.
- For simple deployments scenarios (e.g. for yourself or your own small organization), check our [Kubernetes configurations](https://github.com/workspace-vn/workspace/tree/develop/.deploy/k8s), which we are using to deploy Gauzy demo into [DigitalOcean k8s cluster](https://www.digitalocean.com/products/kubernetes).
- In addition, check [Gauzy Pulumi](https://github.com/workspace-vn/workspace-pulumi) project (WIP), it makes complex Clouds deployments possible with a single command (`pulumi up`). Note: it currently supports AWS EKS (Kubernetes) for development and production with Application Load Balancers and AWS RDS Serverless PostgreSQL DB deployments. We also implemented deployments to ECS EC2 and Fargate Clusters in the same Pulumi project.
...
- [![Gitter](https://badges.gitter.im/JoinChat.svg)](https://gitter.im/workspace-vn/workspace?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
We support the open-source community. If you're building awesome non-profit/open-source projects, we're happy to help and will provide (subject to [acceptance criteria](https://github.com/workspace-vn/workspace/wiki/Free-license-and-hosting-for-Non-profit-and-Open-Source-projects)) Ever Gauzy Enterprise edition license and free hosting option! Feel free to contact us at <mailto:ever@ever.co> to make a request. More details explained in our [Wiki](https://github.com/workspace-vn/workspace/wiki/Free-license-and-hosting-for-Non-profit-and-Open-Source-projects).

This software is available under following licenses:

- [Ever® Gauzy™ Platform Community Edition](https://github.com/workspace-vn/workspace/blob/master/LICENSE.md#gauzy-platform-community-edition-license)
- [Ever® Gauzy™ Platform Small Business](https://github.com/workspace-vn/workspace/blob/master/LICENSE.md#gauzy-platform-small-business-license)
- [Ever® Gauzy™ Platform Enterprise](https://github.com/workspace-vn/workspace/blob/master/LICENSE.md#gauzy-platform-enterprise-license)
...
See our contributors list in [CONTRIBUTORS.md](https://github.com/workspace-vn/workspace/blob/develop/.github/CONTRIBUTORS.md).
You can also view full list of our [contributors tracked by Github](https://github.com/workspace-vn/workspace/graphs/contributors).

<img src="https://contributors-img.web.app/image?repo=workspace-vn/workspace" />
...
[![Circle CI](https://circleci.com/gh/workspace-vn/workspace.svg?style=svg)](https://circleci.com/gh/workspace-vn/workspace)
[![codecov](https://codecov.io/gh/workspace-vn/workspace/branch/master/graph/badge.svg)](https://codecov.io/gh/workspace-vn/workspace)
[![Codacy Badge](https://app.codacy.com/project/badge/Grade/8c46f9eb9df64aa9859dea4d572059ac)](https://www.codacy.com/gh/workspace-vn/workspace/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=workspace-vn/workspace&amp;utm_campaign=Badge_Grade)
...
[![Known Vulnerabilities](https://snyk.io/test/github/workspace-vn/workspace/badge.svg)](https://snyk.io/test/github/workspace-vn/workspace)
[![Total alerts](https://img.shields.io/lgtm/alerts/g/workspace-vn/workspace.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/workspace-vn/workspace/alerts/)
[![Language grade: JavaScript](https://img.shields.io/lgtm/grade/javascript/g/workspace-vn/workspace.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/workspace-vn/workspace/context:javascript)
[![FOSSA Status](https://app.fossa.io/api/projects/git%2Bgithub.com%2Fworkspace-vn%2Fworkspace.svg?type=shield)](https://app.fossa.io/projects/git%2Bgithub.com%2Fworkspace-vn%2Fgauzy?ref=badge_shield)
